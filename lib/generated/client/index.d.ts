...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> = {
    ...
    meta: {
      modelProps: "employee" | "attendance" | "monthlySummary"
    ...
    model: {
      ...
      MonthlySummary: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.MonthlySummaryFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.MonthlySummaryAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export type EmployeeOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "employeeId" | "name" | "createdAt" | "updatedAt", ExtArgs["result"]["employee"]>
  ...
  export interface Prisma__EmployeeClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
    ...
    monthlySummaries<T extends Employee$monthlySummariesArgs<ExtArgs> = {}>(args?: Subset<T, Employee$monthlySummariesArgs<ExtArgs>>): Prisma.PrismaPromise<$Result.GetResult<Prisma.$MonthlySummaryPayload<ExtArgs>, T, "findMany", GlobalOmitOptions> | Null>
    /**
  ...
  export type AttendanceOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "employeeId" | "date" | "inTime" | "outTime" | "workedHours" | "isLeave" | "dayType" | "expectedHours" | "createdAt", ExtArgs["result"]["attendance"]>
  ...
  interface AttendanceFieldRefs {
    ...
    readonly inTime: FieldRef<"Attendance", 'String'>
    readonly outTime: FieldRef<"Attendance", 'String'>
    readonly workedHours: FieldRef<"Attendance", 'Float'>
    readonly isLeave: FieldRef<"Attendance", 'Boolean'>
    readonly dayType: FieldRef<"Attendance", 'String'>
    readonly expectedHours: FieldRef<"Attendance", 'Float'>
  ...
  export type MonthlySummarySelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetSelect<{
    ...
    actualHours?: boolean
    leavesUsed?: boolean
    productivityPercentage?: boolean
    createdAt?: boolean
    updatedAt?: boolean
    employee?: boolean | EmployeeDefaultArgs<ExtArgs>
  ...
  export type MonthlySummaryOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "employeeId" | "month" | "year" | "expectedHours" | "actualHours" | "leavesUsed" | "productivityPercentage" | "createdAt" | "updatedAt", ExtArgs["result"]["monthlySummary"]>
  ...
  export interface MonthlySummaryDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more MonthlySummaries that matches the filter.
     * @param {MonthlySummaryFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const monthlySummary = await prisma.monthlySummary.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: MonthlySummaryFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a MonthlySummary.
     * @param {MonthlySummaryAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const monthlySummary = await prisma.monthlySummary.aggregateRaw({
     *   pipeline: [
     *     { $match: { status: "registered" } },
     *     { $group: { _id: "$country", total: { $sum: 1 } } }
     *   ]
     * })
     */
    aggregateRaw(args?: MonthlySummaryAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  interface MonthlySummaryFieldRefs {
    ...
    readonly expectedHours: FieldRef<"MonthlySummary", 'Float'>
    readonly actualHours: FieldRef<"MonthlySummary", 'Float'>
    readonly leavesUsed: FieldRef<"MonthlySummary", 'Int'>
    readonly productivityPercentage: FieldRef<"MonthlySummary", 'Float'>
  ...
  /**
   * MonthlySummary findRaw
   */
  export type MonthlySummaryFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
  ...
  /**
   * MonthlySummary aggregateRaw
   */
  export type MonthlySummaryAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
  ...
  export type AttendanceWhereInput = {
    ...
    inTime?: StringNullableFilter<"Attendance"> | string | null
    outTime?: StringNullableFilter<"Attendance"> | string | null
    workedHours?: FloatFilter<"Attendance"> | number
    isLeave?: BoolFilter<"Attendance"> | boolean
    dayType?: StringFilter<"Attendance"> | string
    expectedHours?: FloatFilter<"Attendance"> | number
  ...
  export type AttendanceScalarWhereWithAggregatesInput = {
    ...
    inTime?: StringNullableWithAggregatesFilter<"Attendance"> | string | null
    outTime?: StringNullableWithAggregatesFilter<"Attendance"> | string | null
    workedHours?: FloatWithAggregatesFilter<"Attendance"> | number
    isLeave?: BoolWithAggregatesFilter<"Attendance"> | boolean
    dayType?: StringWithAggregatesFilter<"Attendance"> | string
    expectedHours?: FloatWithAggregatesFilter<"Attendance"> | number
  ...
  export type MonthlySummaryWhereInput = {
    ...
    expectedHours?: FloatFilter<"MonthlySummary"> | number
    actualHours?: FloatFilter<"MonthlySummary"> | number
    leavesUsed?: IntFilter<"MonthlySummary"> | number
    productivityPercentage?: FloatFilter<"MonthlySummary"> | number
  ...
  export type MonthlySummaryOrderByWithRelationInput = {
    ...
    leavesUsed?: SortOrder
    productivityPercentage?: SortOrder
    createdAt?: SortOrder
    updatedAt?: SortOrder
    employee?: EmployeeOrderByWithRelationInput
  }
  ...
  export type MonthlySummaryWhereUniqueInput = Prisma.AtLeast<{
    id?: string
    employeeId_month_year?: MonthlySummaryEmployeeIdMonthYearCompoundUniqueInput
    AND?: MonthlySummaryWhereInput | MonthlySummaryWhereInput[]
    OR?: MonthlySummaryWhereInput[]
    NOT?: MonthlySummaryWhereInput | MonthlySummaryWhereInput[]
    employeeId?: StringFilter<"MonthlySummary"> | string
  ...
  export type MonthlySummaryScalarWhereWithAggregatesInput = {
    ...
    expectedHours?: FloatWithAggregatesFilter<"MonthlySummary"> | number
    actualHours?: FloatWithAggregatesFilter<"MonthlySummary"> | number
    leavesUsed?: IntWithAggregatesFilter<"MonthlySummary"> | number
    productivityPercentage?: FloatWithAggregatesFilter<"MonthlySummary"> | number
  ...
  export type AttendanceUpdateInput = {
    ...
    inTime?: NullableStringFieldUpdateOperationsInput | string | null
    outTime?: NullableStringFieldUpdateOperationsInput | string | null
    workedHours?: FloatFieldUpdateOperationsInput | number
    isLeave?: BoolFieldUpdateOperationsInput | boolean
    dayType?: StringFieldUpdateOperationsInput | string
    expectedHours?: FloatFieldUpdateOperationsInput | number
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
  ...
  export type MonthlySummaryUpdateInput = {
    ...
    leavesUsed?: IntFieldUpdateOperationsInput | number
    productivityPercentage?: FloatFieldUpdateOperationsInput | number
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
    updatedAt?: DateTimeFieldUpdateOperationsInput | Date | string
  ...
  export type MonthlySummaryEmployeeIdMonthYearCompoundUniqueInput = {
    employeeId: string
    month: number
    year: number
  }
